...
public class TenantController {
	...
	public ResponseEntity<String> viewTenant(@PathVariable int tenantId) {
		tenantService.viewTenant(tenantId);
		ResponseEntity<String> retvalue = new ResponseEntity<String>(
				"Tenant with ID: " + tenantId + " successfully viewed.", HttpStatus.OK);
		return retvalue;
	}
